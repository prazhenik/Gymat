 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        document.addEventListener("keydown", (function(e) {
            if ("Escape" === e.code && document.documentElement.classList.contains("menu-open")) menuClose(500);
        }));
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                let error = 0;
                if ("phone" === formRequiredItem.getAttribute("data-required") || formRequiredItem.classList.contains("_phone")) if (this.phoneTest(formRequiredItem)) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if ("email" === formRequiredItem.getAttribute("data-required") || formRequiredItem.classList.contains("_email")) {
        ...
        if (vidItem && vidItem.play()) console.log("123eee");
        const pause = () => {
            if (vidItem) {
